...
[Setup]
AppName=Nordware.AddOn.Lumix 1.0.0.15
AppVerName=Nordware.AddOn.Lumix 1.0.0.15
AppPublisher=Nordware
AppPublisherURL=http://www.nordware.io
AppSupportURL=http://www.nordware.io
AppUpdatesURL=http://www.nordware.io
...
[Files]
;Bibliotecas
Source: ..\Nordware.AddOn.Lumix\bin\Debug\Nordware.AddOn.Lumix.exe; Flags: ignoreversion; DestDir: {app}
Source: ..\Nordware.AddOn.Lumix\bin\Debug\Nordware.AddOn.Lumix.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\Nordware.AddOn.Lumix\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Nordware.AddOn.Lumix\bin\Debug\Views\*.srf; DestDir: {app}\Views; Flags: ignoreversion
Source: ..\Nordware.AddOn.Lumix\bin\Debug\Menu\Menu.xml; DestDir: {app}\Menu; Flags: ignoreversion
Source: ..\Nordware.AddOn.Lumix\bin\Debug\Label\*.*; DestDir: {app}\Label; Flags: ignoreversion
